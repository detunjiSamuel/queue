...
router.post('/card/:id/charge', isAuthenticated, cardValidator.checkChargeCard(), handleValidation, cardContoller.chargeCard)
router.delete('/card/:id', isAuthenticated, cardContoller.removeCard)

// savings
router.post('/savings', isAuthenticated, savingsValidator.checkCreateSavings(), handleValidation, savingsController.createSavingPlan)
router.put('/savings/:id', isAuthenticated, savingsValidator.checkEditSavings(), handleValidation, savingsController.editSavingPlan)
