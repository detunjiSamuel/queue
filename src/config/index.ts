...
const config = {
  ...
  merchant: {
    ...
    logo:
      process.env.MERCHANT_LOGO ||
      'https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Mangekyou_Sharingan_Itachi.svg/300px-Mangekyou_Sharingan_Itachi.svg.png',
  },
